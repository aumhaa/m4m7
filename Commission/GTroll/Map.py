...
class CntrlrColors:
	...
	class Translation:
		...
		class Channel_4:
			Grid_0 = LividRGB.MAGENTA
			Grid_1 = LividRGB.MAGENTA
			Grid_2 = LividRGB.MAGENTA
			Grid_3 = LividRGB.MAGENTA
			Grid_4 = LividRGB.MAGENTA
			Grid_5 = LividRGB.MAGENTA
			Grid_6 = LividRGB.MAGENTA
			Grid_7 = LividRGB.MAGENTA
			Grid_8 = LividRGB.MAGENTA
			Grid_9 = LividRGB.MAGENTA
			Grid_10 = LividRGB.MAGENTA
			Grid_11 = LividRGB.MAGENTA
			Grid_12 = LividRGB.MAGENTA
			Grid_13 = LividRGB.MAGENTA
			Grid_14 = LividRGB.MAGENTA
			Grid_15 = LividRGB.MAGENTA

			Button_0 = LividRGB.BLUE
