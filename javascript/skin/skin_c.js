...
var target_keys = {7:'_mod_sustain', 8:'_mask', 9:'_selected_zone', 10:'_color', 12:'_remote_enable', 13:'_remote_scale_lo', 14:'_remote_scale_hi', 15:'_remote_scale_exp', 
				...
				34:'_chordC_channel', 35:'_chord_modC_gate', 37:'_toggle_note', 36:'_modC_chord', 40:'_main_port', 41:'_modA_port', 42:'_modB_port', 43:'_modC_port',
				46:'_main_mono', 47:'_modA_mono', 48:'_modB_mono', 49:'_modC_mono', 50:'_main_clear', 51:'_modA_clear', 52:'_modB_clear', 53:'_modC_clear'};
...
{
	var self = this;
	this.add_bound_properties(this, ['_poly_index', '_zone_index', 'update', 'select_voice', 'current_edit', '_edit_index', '_parameterObjs', 'change_color', '_chord_assigners']);
	...
	this.chord_gates = function(index){return [this._chord_gate, this._chord_madA_gate, this._chord_modB_gate, this._modC_modC_gate][index];}.bind(this);
	...
	this._main_clear = new MomentaryParameter(this._name + '_MainClear', {'onValue':colors.BLUE, 'offValue':colors.OFF, 'value':0, 'callback':self._note_chord.clear_assignment});
	this._modA_clear = new MomentaryParameter(this._name + '_ModAClear', {'onValue':colors.BLUE, 'offValue':colors.OFF, 'value':0, 'callback':self._modA_chord.clear_assignment});
	this._modB_clear = new MomentaryParameter(this._name + '_ModBClear', {'onValue':colors.BLUE, 'offValue':colors.OFF, 'value':0, 'callback':self._modB_chord.clear_assignment});
	this._modC_clear = new MomentaryParameter(this._name + '_ModCClear', {'onValue':colors.BLUE, 'offValue':colors.OFF, 'value':0, 'callback':self._modC_chord.clear_assignment});
...
RegisteredChordNotifier.prototype.receive = function(note, value)
{
	switch(this._mode)
	{
		case 0:
			this.set_value(note);
			//debug('receive mono, new_value is:', polyobj.getvalueof());
			break;
		case 1:
			var pad = ZoneSettings.current_edit();
